...
<div class="container-fluid bg-1 text-center padding-top30">
  ...
  @else
  <h3 class="margin heading-login">Add Details</h3>
  @endif
                ...
                <?php $jobOrderName = \DB::table('job_orders')->find($job_order_id)->title; 
                 ?>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                      <input type="text" class="form-control email" name="primary_email" id="primary_email" required value={{$email}}>
                 ...
                 <div class="col-md-2 title">Date Available</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                    <input type="text" class="form-control" name="key" id="key" required value=" ">
                    <span class="nb-weekly" style="color: red;font-weight:bold;">*** Use this KEY for further Login. ***</span>
                    <div class="text-danger"><p class="error_msg"></p></div>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                  ...
                  <input type="button" id="submit-candidate-personal" name="submit-candidate-personal" value="Apply" class="btn btn-success">
                    ...
                    @else       
                      <input type="button" id="submit-candidate-personal" name="submit-candidate-personal" value="Register" class="btn btn-success">
                     <input type="button" id="clear-form" class="btn btn-primary" value="Clear" />
                      @endif
...
/*$('#key').bind('keypress', function (event) {
  ...
  if (!regex.test(key)) {
   document.getElementById("spnError").style.display = !regex.test(key) ? "block" : "none";
