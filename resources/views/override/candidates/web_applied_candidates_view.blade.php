...
<p>
		...
		<a title='Return' href='/admin/website_candidates'> 
			<i class="fa fa-chevron-circle-left "></i>
			Back To List Data Website Candidates
		</a>
        <a  target="_blank"><button class="btn btn-sm btn-info add_to_joborder" data-toggle="modal" data-toggle="modal" data-target="#addToJobOrderModal{{ $row->id}}" style=" margin-top: -60px;">Add To JobOrder</button>
</a>
	</p>
	<div class="panel panel-default">
		<div class="panel-heading">
			<strong><i class="fa fa-users"></i>&nbsp;&nbsp;Candidate Details&nbsp;&nbsp;</strong>
		</div> 
