	...
	class AdminCountriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
	        ...
	        $this->addaction[] = ['label' => 'States', 'url' => "/admin/states?country_id=[id]"];
    ...
    function removeParam(key, sourceURL) {
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        //Your code here
	    	$duplicateCountry = DB::table('countries')->where('name',$postdata['name'])->first();
	    ...
	    */
	    public function hook_before_edit(&$postdata,$id) {        
	        //Your code here
	        $duplicateCountry = DB::table('countries')->where('name',$postdata['name'])->where('id','!=',$id)->first();
	    ...
	    */
	    public function hook_before_delete($id) {
	        //Your code here
	        $cities = \DB::table('cities')->where('country_id',$id)->delete();
	        
	        $states = \DB::table('states')->where('country_id',$id)->delete();
	    }
