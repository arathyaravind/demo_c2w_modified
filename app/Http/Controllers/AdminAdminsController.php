	...
	class AdminAdminsController extends \crocodicstudio\crudbooster\controllers\CBController {
	        ...
	        */
	        ...
	        "$(document).ready(function(){
				...
				$('#table_dashboard td').each(function(){
					if($(this).text() == '".CRUDBooster::me()->email."') {
						$(this).parent('tr').find('.btn.btn-xs.btn-warning.btn-delete').hide();
						// alert('Hai');
					}
				})
			})";
	    ...
	    */
	    ...
	    public function getDetail($id)	{
			...
			$admin = DB::table($this->table)->where($this->primary_key,$id)->first();
			...
			$admin->jo_count = count($joborders); 
			...
			$this->cbView('override.admins.detail',compact('row','page_menu','page_title','command','id','admin','joborders'));
		}
