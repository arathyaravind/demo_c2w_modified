	...
	class AdminManagersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    ...
	    public function getDetail($id)	{
			...
			$manager = DB::table($this->table)->where($this->primary_key,$id)->first();
			// Get joborders
			$joborders = DB::select(
				"select jo.*,
			...
			$manager->jo_count = count($joborders); 
			
			// TODO Tasklist of admin
			...
			$this->cbView('override.managers.detail',compact('row','page_menu','page_title','command','id','manager','joborders'));
		}
