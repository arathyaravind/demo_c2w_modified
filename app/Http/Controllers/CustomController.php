...
class CustomController extends BaseController
{
    ...
    public function getEvents() {
       ...
       //$loadIds = \DB::table('events') ->select(DB::raw('max(id) as id'))->where('status','pending')->groupBy('job_order_id', 'candidate_id')->orderBy('created_at', 'desc');
        ...
        $events = \DB::table('events')  ->whereIn('id', DB::table('events') ->select(DB::raw('max(id) as id'))->where('status','pending')->groupBy('job_order_id', 'candidate_id')->orderBy('created_at', 'desc'));
