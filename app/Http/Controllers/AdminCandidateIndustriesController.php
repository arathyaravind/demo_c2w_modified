<?php namespace App\Http\Controllers;
	...
	class AdminCandidateIndustriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "candidate_industries";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Candidate Id','name'=>'candidate_id','type'=>'hidden','validation'=>'required','width'=>'col-sm-9'];
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        ...
	        $duplicateIndustry = DB::table('candidate_industries')->where('candidate_id',$candidate_id)->where('industry',$industry)->first();

	        if($duplicateIndustry) {
	        	CRUDBooster::redirect(CRUDBooster::mainpath().'?candidate_id='.$candidate_id,"Already Exists","warning");
	        } else {
	        	$postdata['industry_id'] = $postdata['industry'];
	    ...
	    */
	    ...
	    public function getEdit($id) {
			...
			$this->cbLoader();
			$row = DB::table('candidate_industries')->where('id',$id)->first();
