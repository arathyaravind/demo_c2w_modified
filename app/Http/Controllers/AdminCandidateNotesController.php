<?php namespace App\Http\Controllers;
	...
	class AdminCandidateNotesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Candidate Id','name'=>'candidate_id','type'=>'hidden','width'=>'col-sm-10','datatable'=>'candidate,id'];
